(function($){
    $.fn.yxMobileSlider = function(settings){
        ...
        return this.each(function(){
            ...
            //初始化焦点容器及按钮
            _this.append('<div class="cp-b-p"><div></div></div>');
            var oFocusContainer = $(".cp-b-p");
//          console.log(num)
            for (var i = 0; i < num; i++) {
            	if(num!=1){
                $("div", oFocusContainer).append("<span class='cp-b-pi'></span>");  
               }
            }
            ...
            oFocusContainer.css({
                ...
                position: 'absolute',
                bottom: $(this).find('span').height() * 7,
            ...
            oFocus.first().addClass("cp-b-pia");
            //页面加载或发生改变
...
//          });
            ...
            function doMove(){
                ...
                oFocus.eq(iCurr).addClass("cp-b-pia").siblings().removeClass("cp-b-pia");
            }
            //绑定触摸事件
